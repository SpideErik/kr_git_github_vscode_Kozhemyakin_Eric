...
![01](![alt text](image.png))
2. Инициализированный репозиторий
![02](![alt text](image-1.png))
3. Первый коммит
![03](![alt text](image-2.png))
4. Репозиторий на github
![04](![alt text](image-3.png))
5. Созданная ветка
![05](![alt text](image-4.png))
7. Выполнение Fetch / Pull
[07](![alt text](image-5.png))
8. Итоговая система Git Graph
[08](![alt text](image-6.png))
